...
extern void free_room(void);
extern void check_disk(void);
extern void ls(void);
extern void write_file(char tmp[9],int mode);
...
extern void mkdir(char tmp[9],int type,int mode);
extern void write_a_letter(char tmp[9],int mode);

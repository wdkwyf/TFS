...
#define DATA_BLOCK (512*518) //数据块起始地址
#define BLOCK_BITMAP (512+512) //块位图起始地址
#define INODE_BITMAP (1024+512+512+512) //inode位图起始地址
#define INODE_TABLE_COUNTS 4096 //inode entry 数量:512*8
...
struct inode /*64 bytes */
{
    ...
    unsigned short i_type;//文件类型——local或者contributed
...
//000 Free
//001 Transparent
//010 Free-and-overwritten
//011 Allocated-and-overwritten
//100 Allocated
static unsigned char bitbuf[512];  //位图缓冲区
static unsigned char bitbuf2[512]; //增强位图2
static unsigned char bitbuf3[512]; //增强位图3
